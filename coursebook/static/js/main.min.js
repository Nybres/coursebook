	...
	const createMiniCart = payload => {
		...
		if (cartElement) {
			...
			if (cartItems.length > 0) {
				...
				// cartFooterElement.innerHTML = 'TUTAJ MUSIMY DODAC FOOTER'
				cartItems.forEach(cartItem => {
					...
					<form class="jsQuantity" method="PATCH" action="${URL}/cart/increase-quantity/${cartItem.cartItemId}">
						<div class="nav__cart-container-boxes-box-price-form">
							...
							<input data-max-qty="${cartItem.course.seats}" name="quantity" type="text" value="${cartItem.quantity}" class="nav__cart-container-boxes-box-price-form-input">
