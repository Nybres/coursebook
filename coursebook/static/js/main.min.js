addEventListener('DOMContentLoaded', (event) => {
	...
	// 	// Załóżmy, że masz odpowiedź z API w zmiennej coursesResponse.
	// 	// const coursesResponse = /* Odpowiedź z API z listą kursów */;

	// 	// Pobierz kontener, do którego chcesz dodać elementy HTML (np. <div id="kursy">).
	// 	const coursesContainer = document.getElementById('.nav__cart-container-boxes')

	// 	// Iteruj przez listę kursów i utwórz dla każdego kursu element HTML.
	// 	coursesResponse.forEach((course) => {
	// 		// Utwórz element div reprezentujący kurs.
	// 		const courseElement = document.createElement('div')

	// 		// Wypełnij element danymi kursu.
	// 		courseElement.innerHTML = `
	//   <img class="nav__cart-container-boxes-box-img" src="https://azarog.pythonanywhere.com/media/course_images/kreatywne-gotowanie-roslinne/zdjecie_3_orginal.jpg">
	//   <div class="nav__cart-container-boxes-box-content">
	// 		<p class="nav__cart-container-boxes-box-content-title">Kurs gotowania Włoskiej Kuchni</p>
	// 		<div>
	...
	// 		// Dodaj obsługę zdarzenia do przycisku "Dodaj do koszyka" (jeśli to konieczne).
	// 		const addToCartButton = courseElement.querySelector('.dodaj-do-koszyka')
	// 		addToCartButton.addEventListener('click', () => {
	// 			// Tutaj możesz obsłużyć dodawanie kursu do koszyka.
	// 			// Możesz użyć wcześniejszego kodu, aby dodać kurs do koszyka.
	// 		})

	// 		// Dodaj utworzony element kursu do kontenera.
