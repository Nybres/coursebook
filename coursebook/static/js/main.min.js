addEventListener('DOMContentLoaded', (event) => {
	...
	const checkLengthText = () => {
		checkTextLength(textAddInstructor, 30)
	}
	...
	const checkBlogTitle = () => {
		checkTitleLength(blogTextTitle, 20)
	}
	...
	const checkBlogTextDescription = () => {
		checkTextLength(blogTextDescription, 30)
	}
	...
	const checkCourseTitle = () => {
		checkTitleLength(addCourseTitle, 20)
	}
	if (addCourseTitle) {
	...
	const checkCourseText2 = () => {
		checkTextLength(addCourseShortDescribe, 30)
	}
	...
	const checkCourseText3 = () => {
		checkTextLength(addCourseDescribe, 30)
	}
	...
	const checkCourseText4 = () => {
		checkTextLength(addCourseForWho, 30)
	}
	if (addCourseForWho) {
	...
	const checkCourseText5 = () => {
		checkTextLength(addCourseBenefits, 30)
	}
