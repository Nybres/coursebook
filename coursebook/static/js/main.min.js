addEventListener('DOMContentLoaded', event => {
		...
		btn.addEventListener('click', e => {
			...
			fetch('/edit-instructor/' + instructorId, {
				...
				.then(data => {
					...
					if (data.photo) {
						// <input type="hidden" name="photo_change" value="" />

						// const photoChangeInput = document.querySelector('input[name="photo_change"]')
						// photoChangeInput.value = data.photo.url
						...
						const paresdUrl = new URL(data.photo)
	...
	// 						const elementToDelete = e.target.closest('.form__images-image')
	// 						elementToDelete.remove()
	// 						const photoUnchangedInput = document.querySelector('input[name="photo_unchanged"]')
	// 						photoUnchangedInput.value = false
	// 					})
	// 				}
	// 			})
	// 	})
	...
	//       e.preventDefault();
	// 	  const photoUnchangedInput = document.querySelector(
	// 		'input[name="photo_unchanged"]'
	// 	  );
	// 	  photoUnchangedInput.value = false;
