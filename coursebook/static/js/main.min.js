addEventListener('DOMContentLoaded', event => {
	...
	// cart - create object to checkout
	...
	if (orderCheckoutData) {
		const cartOrderName = document.querySelector('#cart-order-name')
		const cartOrderSurname = document.querySelector('#cart-order-surname')
		const cartOrderemail = document.querySelector('#cart-order-email')
		const cartOrderPhone = document.querySelector('#cart-order-phone')

		console.log(cartOrderName.value)
	}
