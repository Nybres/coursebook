addEventListener('DOMContentLoaded', (event) => {
	...
	const checkAlllabels = () => {
		if (!doneAlllabels) {
			...
			labelElementAll.classList.add('splide__slide', 'offert__nav', 'jsLabel', 'offert__jsLabel')
	...
	const createCourseCard = (course) => {
		...
		// const splideList = document.querySelector('.jsAddOffer')
         ...
         <div class="offert-card">
            ...
            <div class="offert-card__body">
               ...
               <div class="offert-card__body-action">
                  <a href="${URL}/course/${course.province_slug}/${course.slug}" class="btn btn--primary">Poznaj ofertę
                     <span class="btn__arrow">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                           xmlns="http://www.w3.org/2000/svg">
                           <path d="M12 20L10.575 18.6L16.175 13H4V11H16.175L10.575 5.4L12 4L20 12L12 20Z"
      ...
      if (course) {
		provinceLabel.addEventListener('click', (e) => {
			if (e.target.classList.contains('splide__slide')) {
				...
				province = provinceLowercase(province) // pobrany data-atrybut z labela ze zmienioną pierwszą literą na małą, aby pasował do danych w obiekcie (nazwa województwa)

            // console.log(province);

            course.forEach(item => {
            let prov = item.province_slug // pobrane województwa z obiektu
            ...
            if (province === prov) {
               ...
               console.log(course); // obiekty z kursami
            }
